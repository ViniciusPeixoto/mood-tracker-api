...
class AbstractRepository(ABC):
    def add_humor(self, humor: Humor):
    ...
    @abstractmethod
    def _add_humor(self, humor: Humor):
        raise NotImplementedError

    @abstractmethod
    def _get_humor_by_id(self, humor_id: int):
        raise NotImplementedError

    @abstractmethod
    def _get_humor_by_date(self, humor_date: datetime):
        raise NotImplementedError

    @abstractmethod
    def _add_water_intake(self, water_intake: Water):
        raise NotImplementedError

    @abstractmethod
    def _get_water_intake_by_id(self, water_intake_id: int):
        raise NotImplementedError

    @abstractmethod
    def _get_water_intake_by_date(self, water_intake_date: datetime):
        raise NotImplementedError

    @abstractmethod
    def _add_exercises(self, exercises: Exercises):
        raise NotImplementedError

    @abstractmethod
    def _get_exercises_by_id(self, exercises_id: int):
        raise NotImplementedError

    @abstractmethod
    def _get_exercises_by_date(self, exercises_date: datetime):
        raise NotImplementedError

    @abstractmethod
    def _add_food_habits(self, food_habits: Food):
        raise NotImplementedError

    @abstractmethod
    def _get_food_habits_by_id(self, food_habits_id: int):
        raise NotImplementedError

    @abstractmethod
    def _get_food_habits_by_date(self, food_habits_date: datetime):
        raise NotImplementedError

    @abstractmethod
    def _add_mood(self, mood: Mood):
        raise NotImplementedError

    @abstractmethod
    def _get_mood_by_id(self, mood_id: int):
        raise NotImplementedError

    @abstractmethod
    def _get_mood_by_date(self, mood_date: datetime):
        raise NotImplementedError
